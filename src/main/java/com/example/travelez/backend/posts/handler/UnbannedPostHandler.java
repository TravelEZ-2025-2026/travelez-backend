...
@Slf4j
public class UnbannedPostHandler implements PostsNotificationHandler {
    @Override
    public PostStatusAction getSupportedActionStatus() {
        return PostStatusAction.UNBANNED;
    }
    ...
    public SystemNotificationRequest buildPayload(PostsStatusChangedEvent event) {
        return SystemNotificationRequest.builder()
                ...
                .title("Post unbanned")
                .message("Your post has been unbanned. Reason: " + event.getReason())
                .type(NotificationType.POST_UNBANNED)
